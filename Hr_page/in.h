    ...
    <script>
        ...
        async function resolveTicket(ticketId) {
            if (confirm('Mark this ticket as resolved?')) {
                try {
                    const response = await fetch(`http://54.166.206.245:3025/api/tickets/${ticketId}/status`, {
                        method: 'PUT',
                        headers: {
        ...
        async function updateStatus(newStatus) {
            ...
            try {
                const response = await fetch(`http://54.166.206.245:3025/api/tickets/${currentTicketId}/status`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function addComment() {
            ...
            try {
                const response = await fetch(`http://54.166.206.245:3025/api/tickets/${currentTicketId}/comments`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
